...
public class UserService {
    ...
    public boolean registerUser(String username, String mail,String nome,String cognome, String password,String ruolo,String telefono, Connection conn) throws SQLException {
        if (doesUserExist(mail, conn, "utenti")) {
            return false;
        }
    ...
    public void updateUser(String username, String mail,String nome,String cognome, String password, String ruolo, String telefono, int id) {
    ...
    private boolean doesUserExist(String mail, Connection conn, String table) throws SQLException {
    ...
    public List<User> getAllUsers() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                if(rs.getString("telefono")==null)u.setTelefono("");
