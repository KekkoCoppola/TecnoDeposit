...
<head>
    ...
    <title>Errore Interno - TecnoDeposit</title>
    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden pulse">
        ...
        <div class="p-8 text-center">
            <div class="mb-6">
                ...
                <h2 class="text-4xl font-bold text-gray-800 mb-2">500</h2>
                <h3 class="text-2xl font-semibold text-gray-700">Errore Interno Del Server</h3>
            </div>
            
            <p class="text-gray-600 mb-8">
                Sembra che abbiamo avuto un problema nel nostro server.
                <br>
                Ritenta più tardi o torna alla pagina principale.
            </p>
