...
<body class="bg-gradient-to-br from-red-50 to-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-md">
        ...
        <div class="logo-space bg-gradient-to-r from-red-500 to-gray-600 p-8 flex items-center justify-center">
            <div class="w-32 h-32 bg-white/20 rounded-full flex items-center justify-center border-4 border-white/30">
                <img src="img/Icon.png" class="fas fa-user-circle text-white text-6xl opacity-80 animate-float" style="animation: float 3s ease-in-out infinite;" height= 100 width= 100>
            ...
            <input type="hidden" name="csrfToken" value="${csrfToken}">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="username" name="username" type="text" required 
                            ...
                            placeholder="Inserisci l'username" autocapitalize="none" autocomplete="off" autocorrect="off"  oninput="this.value = this.value.toLowerCase();">
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <!--  <div class="flex items-center">
                        <input id="remember-me" name="remember-meOFF" type="checkbox" 
                            class="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500">
                        <label for="remember-me" class="ml-2 block text-sm text-gray-700">Ricordami</label>
                    </div>-->

                    <div class="text-sm">
                        <a href="#" class="font-medium text-gray-600 hover:text-red-500" onclick="alert('Contatta il supporto TecnoDeposit a : assistenza@tecnodeposit.it')">Password Dimenticata?</a>
                    </div>
                </div>
    ...
    <% 
    	String errore = (String) request.getAttribute("loginError"); 
    	String flash = (String) session.getAttribute("FLASH_LOGIN_ERROR");
    %>
	<% if (errore != null || flash!=null) { %>
	<div id="notificaErrore" class="fixed top-5 left-1/2 transform -translate-x-1/2 bg-red-500 text-white px-4 py-2 rounded shadow z-50 animate-slide-down">
	  <i class="fas fa-exclamation-circle mr-2"></i><%= (flash != null ? flash : errore) %>
	</div><% session.removeAttribute("FLASH_LOGIN_ERROR");} %>
