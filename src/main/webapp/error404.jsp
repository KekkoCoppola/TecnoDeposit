...
<head>
    ...
    <title>Pagina non trovata - TecnoDeposit</title>
    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden pulse">
        <div class="bg-[#e52c1f] py-4 px-6">
            <h1 class="text-white text-2xl font-bold">
                <i class="fas fa-warning mr-2"></i> Attenzione
            </h1>
        </div>
        ...
        <div class="p-8 text-center">
            <div class="mb-6">
                ...
                <h2 class="text-4xl font-bold text-gray-800 mb-2">404</h2>
                <h3 class="text-2xl font-semibold text-gray-700">Pagina non trovata</h3>
            </div>
            
            <p class="text-gray-600 mb-8">
                Sembra che il prodotto o la pagina che stai cercando non sia disponibile nel nostro magazzino.
                <br>
                Verifica l'URL o torna alla pagina principale.
            </p>
