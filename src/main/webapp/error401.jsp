...
<head>
    ...
    <title>Operazione Non Autorizzata - TecnoDeposit</title>
    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden pulse">
        <div class="bg-[#e52c1f] py-4 px-6">
            <h1 class="text-white text-2xl font-bold">
                <i class="fa-solid fa-shield-halved"></i> Operazione Non Autorizzata 
            </h1>
        </div>
        ...
        <div class="p-8 text-center">
            <div class="mb-6">
                ...
                <h2 class="text-4xl font-bold text-gray-800 mb-2">401</h2>
                <h3 class="text-2xl font-semibold text-gray-700"> Operazione Non Autorizzata</h3>
            </div>
            
            <p class="text-gray-600 mb-8">
                L'operazione che hai richiesto non è andata a buon fine a causa di autorizzazioni non sufficienti.
                <br>
                Ritenta assicurandoti di avere i permessi o contatta l'assistenza.
            </p>
            
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="<%= request.getContextPath() %>/dashboard" class="border-2 border-custom-red text-custom-red hover:bg-gray-100 font-bold py-3 px-6 rounded-lg transition duration-300">
