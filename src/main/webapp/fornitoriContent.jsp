    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <header class="mb-10">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button id="addSupplierBtn" class="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg flex items-center gap-2 transition-colors">
        ...
        <div class="mb-8 bg-white p-6 rounded-xl shadow-sm">
            <div class="flex flex-col md:flex-row gap-4 mb-6">
                <div class="relative flex-grow">
                    ...
                    <input type="text" id="searchInput" placeholder="Cerca ..." class="search-input pl-10 pr-4 py-2 w-full border border-gray-300 rounded-lg focus:border-red-500">
                </div>
...
<!--  
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-white p-4 rounded-xl shadow-sm border-l-4 border-red-500">
                ...
                <p class="text-2xl font-bold"><%=fornitori2.countFornitori() %></p>
            </div>
    ...
    <!-- Add Supplier Modal -->
    <div id="addSupplierModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl p-6 w-full max-w-md">
            <div class="flex justify-between items-center mb-4">
                <h3 id="modal-title" class="text-xl font-bold text-gray-800">Aggiungi nuovo centro revisione</h3>
            ...
            <input type="hidden" name="action" id="formAction" value="add">
                <div class="mb-4">
                    ...
                    <input type="text" id="supplierName" name="nome" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-red-500">
                </div>
                <!--  <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="supplierMail" name="mail" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-red-500">
                </div>
                <div class="mb-4">
                    <label for="supplierLocation" class="block text-gray-700 mb-2">Indirizzo</label>
                    <input type="text" id="supplierLocation" name="indirizzo" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-red-500">
                </div>
                <div class="mb-4">
                    <label for="supplierPhone" class="block text-gray-700 mb-2">Telefono</label>
                    <input type="text" id="supplierPhone" name="telefono" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-red-500">
                </div>
                <div class="mb-4">
                    <label for="supplierIva" class="block text-gray-700 mb-2">Partita IVA (opzionale)</label>
                    <input type="text" id="supplierIva" name="iva" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-red-500">
                </div>
                <div class="flex justify-end gap-3 mt-6">
                    <button type="button" id="cancelBtn" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100">Annulla</button>
                    <button type="submit" id="saveBtn" class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600">Salva</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-5xl sm:w-full">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:items-center sm:justify-between border-b border-gray-200">
                ...
                <button onclick="closeModalCatalogo()" class="text-gray-400 hover:text-gray-500 focus:outline-none">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse border-t border-gray-200">
                <button type="button" onclick="closeModalCatalogo()" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm">
                    Chiudi
                </button>
            </div>
        </div>
...
<div id="deleteModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md fade-in">
            <div class="p-6">
                ...
                <p class="text-gray-600 text-center mb-6">Sei sicuro di voler eliminare questo centro? Questa azione non può essere annullata.</p>
                <div class="flex justify-center space-x-4">
                    <button class=" cancel-delete px-4 py-2 border rounded-lg hover:bg-gray-100">
                        Annulla
                    </button>
                    <button id="confirmDeleteBtn" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg" name="delete">
                        Elimina
                    </button>
                </div>
            </div>
